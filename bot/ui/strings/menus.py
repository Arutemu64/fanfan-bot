...
helper_menu_text = f"""📣 <b>Для волонтёров доступны следующие функции:</b>

<b>{buttons.announce_mode}</b>
С помощью данного режима вы можете оперативно оповещать зрителей о том, что происходит на сцене
"""

org_menu_text = """🔧 <b>Для организаторов доступны следующие команды:</b>
