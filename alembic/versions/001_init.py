...
def upgrade() -> None:
    ...
    sa.Column('announcement_timeout', sa.Integer(), server_default='10', nullable=False),
    ...
    sa.Column('role', postgresql.ENUM('VISITOR', 'PARTICIPANT', 'HELPER', 'ORG', name='userrole'), server_default='VISITOR', nullable=False),
    ...
    sa.UniqueConstraint('user_id', 'achievement_id', name=op.f('uq_received_achievements_user_id'))
    )
    ...
    sa.Column('position', sa.Float(), server_default=sa.text("nextval('schedule_position_seq')"), nullable=False),
    ...
    sa.UniqueConstraint('position', deferrable='True', initially='DEFERRED', name=op.f('uq_schedule_position')),
    )
    ...
    sa.UniqueConstraint('event_id', 'user_id', name=op.f('uq_subscriptions_event_id'))
    )
...
def downgrade() -> None:
    ...
    postgresql.ENUM('VISITOR', 'PARTICIPANT', 'HELPER', 'ORG', name='userrole').drop(op.get_bind())
